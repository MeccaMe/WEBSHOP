...
<ul id="dropdown4" class="dropdown-content dropdown-tasks w250 taskList">
  <li>
	   ...
	   <!--/. NAV TOP  -->
        ...
        <div id="page-wrapper" >
		  <div class="header"> 
						...
						<ol class="breadcrumb">
					  <li><a href="${ctx}/backstage/main.jsp">Home</a></li>
    ...
    <form action="${ctx}/goods/addGoods" class="col s12" method="post">
      <div class="row">
        <div class="input-field col s12">
          <input name="gname" id="first_name" type="text" class="validate">
      ...
      <div class="row">
        <div class="input-field col s12">
          <input  name="detail" id="first_name" type="text" class="validate">
          <label for="first_name">简介</label>
        </div> 
      </div>
      <div class="row">
        <div class="input-field col s12">
          <input name="price" id="first_name" type="text" class="validate">
          <label for="first_name">单价</label>
        </div> 
      </div>
      <div class="row">
		<div class="input-field col s12">
			<input id="first_name" name="type.typeid" type="text" class="validate">
			<label for="first_name">类型(请输入类型序号1.juice 2.tea 3.milk tea 4.coffee 5.ice cream 6.dessert 7.milk shake)</label>
		</div>							
	 </div>
	 <div class="row">
        <div class="input-field col s12">
