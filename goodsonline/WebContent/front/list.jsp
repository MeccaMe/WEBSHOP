						...
						<div class="product-grid">
							...
							<div class="product-info simpleCart_shelfItem">
								<div class="product-info-cust prt_name">
									...
									<input type="text" class="item_quantity" value="1" /><a href="${ctx }/cart/addCart?gid=${goods.gid}&uname=${u.uname}"><input
										type="button" class="item_add items" value="Add"></input></a> 
									<div class="clearfix"></div>
								</div>
							</div>
						</div>					
