		...
		<div class="container">
			...
			<div class="header-info">
				...
				<div class="header-right cart">
					<a href="${ctx }/cart/showInCart?uname=${u.uname}"><span class="glyphicon glyphicon-shopping-cart" aria-hidden="true"></span></a>
					<div class="cart-box">
						<h4><a href="${ctx }/cart/showInCart?uname=${u.uname}">
